  ...
  <div>
      ...
      <div slot="button">
        <el-dropdown @command="buttonCommand">
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item :command="{key:'interview'}">安排面试</el-dropdown-item>
    ...
    <el-dialog :visible.sync="viewModal" title="标记结果" width="600px">
      <el-form :model="viewForm" ref="viewForm" label-width="110px">
        ...
        <el-form-item label="面试时间" prop="NextTime" :rules="{required:viewForm.status[0] === '11915700-8bd5-11e8-86f8-44a84203f5fd',message:'请选择面试时间'}">
          <el-date-picker v-model="viewForm.NextTime" type="datetime" placeholder="请选择面试时间" style="width:100%" :picker-options="pickerOptions" :disabled="viewForm.status[0] !== '11915700-8bd5-11e8-86f8-44a84203f5fd'" value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
        </el-form-item>
        <el-form-item label="预约回访时间" prop="VisitTime">
          <el-date-picker v-model="viewForm.VisitTime" type="datetime" placeholder="请选择回访时间" style="width:100%" :picker-options="pickerOptions" :disabled="viewForm.status[0] === '11915700-8bd5-11e8-86f8-44a84203f5fd'" value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
        </el-form-item>
      </el-form>
      <div slot="footer">
...
import { getInvitationList, saveInvitation } from '@/api/recruiting/invitation'
import { saveDealLink, addDial } from '@/api/recruiting/link'
import { parseTime } from '@/utils'
export default {
  name: 'ResumeInvitation',
  components: {
    TopOperating,
    PanelMain
  },
  ...
  methods: {
    ...
    openViewModel(id, type) {
      ...
      this.viewModal = true
      if (!type) {
        this.viewForm.status = ['11915700-8bd5-11e8-86f8-44a84203f5fd']
      } else {
        this.viewForm.status = [
          '87e445dd-8bd5-11e8-86f8-44a84203f5fd',
          'a15a4006-8bd5-11e8-86f8-44a84203f5fd'
        ]
      }
  ...
  created() {
    ...
    this.getData()
    getDataDictTree('716879ec-8bd4-11e8-86f8-44a84203f5fd').then(res => {
