  ...
  <div>
      ...
      <div slot="button">
        <el-dropdown @command="buttonCommand">
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item :command="{key:'notice'}">安排报到</el-dropdown-item>
    ...
    <el-dialog :visible.sync="viewModal" title="标记结果" width="600px">
      <el-form :model="viewForm" ref="viewForm" label-width="110px">
        ...
        <el-form-item label="报到时间" prop="NextTime" :rules="{required:viewForm.status[0] === 'd00491b6-8ef3-11e8-86f8-44a84203f5fd',message:'请选择报到时间'}">
          <el-date-picker v-model="viewForm.NextTime" type="datetime" placeholder="请选择报到时间" style="width:100%" :picker-options="pickerOptions" :disabled="viewForm.status[0] !== 'd00491b6-8ef3-11e8-86f8-44a84203f5fd'" value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
        </el-form-item>
        <el-form-item label="预约回访时间" prop="VisitTime" :rules="{required:viewForm.status[0] === 'd2740a67-8ef3-11e8-86f8-44a84203f5fd',message:'请选择时间'}">
          <el-date-picker v-model="viewForm.VisitTime" type="datetime" placeholder="请选择预约时间" style="width:100%" :picker-options="pickerOptions" :disabled="viewForm.status[0] !== 'd2740a67-8ef3-11e8-86f8-44a84203f5fd'" value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
        </el-form-item>
      </el-form>
      <div slot="footer">
        <el-button @click="viewModal=false">取消</el-button>
        <el-button type="primary" :loading="saveing" @click="notice">确定</el-button>
      </div>
    </el-dialog>
...
import { getNoticeList, saveNotice } from '@/api/recruiting/notice'
...
export default {
  ...
  methods: {
    ...
    openViewModel(id, type) {
      ...
      this.viewModal = true
      if (!type) {
        this.viewForm.status = ['d00491b6-8ef3-11e8-86f8-44a84203f5fd']
      } else if (type === 1) {
        this.viewForm.status = ['d2740a67-8ef3-11e8-86f8-44a84203f5fd']
      }
  ...
  created() {
    ...
    this.getData()
    getDataDictTree('a9466b2f-8ef3-11e8-86f8-44a84203f5fd').then(res => {
